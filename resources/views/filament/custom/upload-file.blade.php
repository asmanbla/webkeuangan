...
.submit-btn {
    background-color:#1F1C69; /* Warna oranye */
    color: white;
    font-weight: bold;
    font-size: 14px;
    border-radius: 8px;
...
.submit-btn:hover {
    background-color:#6366f1; /* Warna oranye gelap saat hover */
}
...
<div wire:loading wire:target="importData" class="text-blue-500 mt-2">
    Process Import...
</div>
